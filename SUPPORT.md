...
rune follows the same policy as the rest of the Torvik project. Every major version is supported for **five
...
[the Torvik tooling docs](https://github.com/torvik-lang/torvik/blob/main/docs/TOOLING.md). A 1.x project keeps receiving fixes for five years
...
Report privately through this repository's Security tab. Security fixes are backported
to every line still in Active, Maintenance, or Security support.
